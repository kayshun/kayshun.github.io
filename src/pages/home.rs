        ...
        <Layout>
            ...
            <Grid class="w-screen flex-1">
                ...
                <Grid>
                    ...
                    <GridItem class="pl-8 pt-2 bg-gray-50">
                        <h3 class="font-oswald text-xl ">"Knowing your students' progress needs assessment"</h3>
                        <p class="text-base  pb-2 max-w-prose">"Consistent assessment and timely, focussed, and high-quality feedback are vital to students' progress. Numerous studies have shown that students who receive such feedback perform better and are much more engaged. But to achieve our goal takes up time!"</p>
                    </GridItem>

                    <GridItem class="pl-14 pt-4 pb-3">
                        <div class="flex">
                    ...
                    <GridItem class="pl-16 pb-4">
                        <p class="text-xl italic anim-fade-in-5">"Kayshun can do all that for you! "<span class="text-green-400">"✔️"</span></p>
                    </GridItem>

                    <GridItem class="pl-8 pb-2">
